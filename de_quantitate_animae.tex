...
The second passage involves the stick analogy that Alexander of Aphrodisias attributes to the Stoics in \emph{De anima} 130 14 (the Stoic analogy is discussed and criticized by Galen in \emph{De Placitis Hippocratis et Platonis} 7.7 and echoed by Descartes in \emph{La Dioptrique}):
\begin{quote}
...
\end{quote}
Notice how Gilson understands \emph{non latere animam} as the soul's attentive vigilance. The positive characterization that Gilson sees in Augustine's roundabout expression is metaphysically significant. That something is not hidden from the range of the soul's attention is due to the soul's vigilant activity.
...
A preliminary definition of perception was offered by Augustine to Evodius to defend in chapter 23. More refined versions of that definition will be given in \emph{De quantitate animae} 25.48, 26.49, and 30.59:
\begin{quote}
